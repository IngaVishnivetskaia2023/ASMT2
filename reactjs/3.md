...
- Which values should not be added to the useEffect() dependencies array?
- Which value can be returned by the effect function? And which kind of value must not be returned?
